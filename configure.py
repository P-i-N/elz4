...
def generate_project_def(solution_name, dir):
    ...
    if os.path.isfile(os.path.join(dir, "main.c")) or os.path.isfile(
        os.path.join(dir, "main.cpp")
    ):
...
""".format(
    ...
    if not os.path.isdir("src"):
        ...
        for project_name in os.listdir("src"):
            ...
            content += generate_project_def(
                solution_name, forward_slashes(project_path)
            )
